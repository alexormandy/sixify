        ...
        <div className="navbar">
            <div className="navbar-Flex-Container"> 
                ...
                <div className="top-Nav-Section2">
                    <div className="home">
                        <button className="home-Button">Home</button></div>
                    <div className="search">
                        <button className="search-Button">Search</button></div>
                    <div className="library">
                        <button className="library-Button">Library</button></div>
                </div>
                ...
                <div className="bottom-Nav">
                    ...
                    <div className="new-Playlist">
                        <button className="new-Playlist-Button">New Playlist</button></div> 
                </div>
            </div>    
        </div>
    ); 
